...
import profilePic from '../assets/headshot3.jpg'

const ProfileCard = () => {
    return (
        <div className="max-w-4xl mx-auto bg-white drop-shadow-[0_0px_10px_rgba(0,0,0,0.25)]  my-8 flex flex-col md:flex-row items-center">
            <div className="px-8 flex-1 text-center md:text-left order-1 md:order-2">
                <h1 className="text-4xl md:text-4xl font-bold text-gray-800 mb-4">Benjamin Barrera-Altuna</h1>
                <p className="text-2xl mb-2">Computer Science Major</p>
                <p className="text-2xl mb-6">University of South Florida, Tampa</p>
            ...
            <div className="px-8 py-4 flex-none">
                <div className="rounded-full overflow-hidden">
                    <img src={profilePic} className="h-40 w-40 md:h-60 md:w-60 mx-auto object-cover transition-transform duration-300 ease-in-out hover:scale-110" alt="Profile Picture" />
                </div>
            </div>
        </div>
    );
...
const EmailButton = () => {
    return (
        <a href="mailto:benbarrera13@gmail.com" target="_blank">
            <button
                type="button"
...
const LinkedInButton = () => {
    return (
        <a href="https://www.linkedin.com/in/benbarreraa/" target="_blank">
            <button
                type="button"
...
const GithubButton = () => {
    return (
        <a href="https://github.com/BABTUNA" target="_blank">
            <button
                type="button"
